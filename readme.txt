...
docker run -d -it -p 80:8501 --network test-net --name frontend-container test-frontend
...
docker run -d --name aifront-container --network mynetwork -p 80:8501 rujalmhn/aifront:1.0
